...
class TournamentBet(models.Model):
    ...
    # TODO Ce qui suit est a supprimer car la validation du formulaire ne fonctionne pas
    # il indique que la chaine de caractere n'est pas un objet Team
    ...
    # TODO j'ai decommente ce qui suit
